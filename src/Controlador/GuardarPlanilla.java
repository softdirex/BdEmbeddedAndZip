...
public class GuardarPlanilla {
    public void generarExcelRespaldo(String[][] entrada, String name){
        try {
            WorkbookSettings conf = new WorkbookSettings();
            conf.setEncoding("ISO-8859-1");
        
            WritableWorkbook woorbook = Workbook.createWorkbook(new File("."+File.separator+"RSP"+File.separator+name+".xls"),conf);
